    ...
    if (this.props.continent === 'N. America') {
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="Capitals: Mexico" onClick={() => this.props.onButtonClick('NA', false, 'MX', true)} />
          <MenuItem style={style} primaryText="Provinces: Canada" onClick={() => this.props.onButtonClick('NA', false, 'CA', false)} />
          <MenuItem style={style} primaryText="Capitals: Canada" onClick={() => this.props.onButtonClick('NA', false, 'CA', true)} />
        </Menu>
      )
      ...
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="States: Brazil" onClick={() => this.props.onButtonClick('SA', false, 'BR', false)} />
        </Menu>
      )
      ...
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="Capitals: South Africa" onClick={() => this.props.onButtonClick('AF', false, 'ZA', true)} />
        </Menu>
      )
      ...
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="Capitals: United Kingdom" onClick={() => this.props.onButtonClick('EU', false, 'GB', true)} />
        </Menu>
      )
      ...
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="States: India" onClick={() => this.props.onButtonClick('AS', false, 'IN', false)} />
        </Menu>
      )
      ...
      menuItems = (
        <Menu>
          ...
          <MenuItem style={style} primaryText="Capitals: Australia" onClick={() => this.props.onButtonClick('OC', false, 'AU', true)} />
        </Menu>
      )
    } else {
